                                                    ...
                                                    <a class="media-link" href="#">
                                                        ...
                                                        <div class="media-body text-right">
                                                            ...
                                                            <p class="font-small-2 text-muted m-0 success">283.1 USD
                                                                (+2.33%)</p>
                                                            <p class="font-small-2 text-muted m-0 text-bold-600">
                                                                1029.1906 BTC</p>
                                                        </div>
                                                    </a>
                                                </div>
                                                <div
                                                    ...
                                                    <a class="media-link" href="#">
                                                        ...
                                                        <div class="media-body text-right">
                                                            ...
                                                            <p class="font-small-2 text-muted m-0 success">56.1 EUR
                                                                (+5.52%)</p>
                                                            <p class="font-small-2 text-muted m-0 text-bold-600">
                                                                560.1906 BTC</p>
                                                        </div>
                                ...
                                <div class="heading-elements">
                                    <ul class="list-inline mb-0">
                                        ...
                                        <li class="text-center">
                                            ...
                                            <p class="text-bold-600 mb-0"><i class="cc BTC-alt" title="BTC"></i>
                                                1029.1906 BTC</p>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="card-body">
                                    <ul class="nav nav-tabs nav-underline no-hover-bg">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="base-market" data-toggle="tab"
                                                aria-controls="market" href="#market" aria-expanded="false">Market</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="tab-content px-1 pt-1">
                                        <div role="tabpanel" class="tab-pane active" id="limit" aria-expanded="true"
                                            ...
                                            <div class="row">
                                                <div
                                                    class="col-12 col-xl-6 border-right-blue-grey border-right-lighten-4 pr-2">
                                                    <div class="row my-2">
                                                        <div class="col-4">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="number" disabled
                                                                        id="btc-limit-buy-total" class="form-control"
                                                    ...
                                                    <form class="form form-horizontal">
                                                        <div class="form-body">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="number" id="btc-price"
                                                                        class="form-control" placeholder="$ 11916.9"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="number" disabled
                                                                        id="btc-limit-sell-total" class="form-control"
                                                                        placeholder="$ 318.1856"
                                        ...
                                        <div class="tab-pane" id="market" aria-labelledby="base-market">
                                            <div class="row">
                                                <div
                                                    class="col-12 col-xl-6 border-right-blue-grey border-right-lighten-4">
                                                    <div class="row my-2">
                                                        <div class="col-4">
                                                            <h5 class="text-bold-600 mb-0">Buy BTC</h5>
                                                        </div>
                                                    ...
                                                    <form class="form form-horizontal">
                                                        <div class="form-body">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="number" disabled
                                                                        id="btc-market-buy-price" class="form-control"
                                                    ...
                                                    <form class="form form-horizontal">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="number" disabled
                                                                        id="btc-stop-buy-total" class="form-control"
                                                                        placeholder="$ 318.1856"
                                                    ...
                                                    <form class="form form-horizontal">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="number" disabled
                                                                        id="btc-stop-sell-total" class="form-control"
                                                                        placeholder="$ 318.1856"
                            ...
                            <div class="card-header">
                                ...
                                <div class="heading-elements">
                                    <button class="btn btn-sm round btn-danger btn-glow"><i
                                            class="la la-close font-medium-1"></i>
                                        Cancel all</button>
                                </div>
                            </div>
                            <div class="card-content">
                                    ...
                                    <table class="table table-de mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>$ 6979.78</td>
                                                <td>0.2</td>
                                                <td><button class="btn btn-sm round btn-outline-danger"> Cancel</button>
                                                </td>
                                            </tr>
                                            <tr>
